...
- The evaluation draws on two data sources: (a) the school-specific crawl vector store content (published HTCCS site materials) and (b) the knowledge-base vector store containing the Six Essential Elements of a Classical School (1) rubric and related lexicon. The public HTCCS materials were analyzed against the Positive/Negative Keyword Indicators drawn from the Classical School lexicon, including terms like truth, virtue, theology, liturgy, Great Books, grammar/logic/rhetoric, Socratic pedagogy, Scholé, and partnership with families. Key quotes and phrases are cited inline to illustrate alignment, and the six-category rubric is applied to derive category-level classifications and the aggregate assessment. Citations reference the HTCCS public materials, such as Mission & Vision, Distinctively Christian materials, Upper School pedagogy, Great Books/Latin content, and Parent/Community materials. See citations for the exact sources.
