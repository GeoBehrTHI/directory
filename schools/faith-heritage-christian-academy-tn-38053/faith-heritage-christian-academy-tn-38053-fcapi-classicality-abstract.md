...
- What would move the needle: See “What Would Move the Needle” above for concrete steps to elevate FHCA toward full CLASSICAL, focusing on curriculum expansion (Great Books, classical languages), pedagogy (Socratic, scholé), and formalization of teacher and parent partnerships.

Notes on sources used
- FHCA mission, curriculum elements, and family/community references were drawn directly from FHCA’s on-site materials and related public pages.   
- The classical-education keyword framework and positive/negative indicators come from the Six Essential Elements of a Classical School (1) document and its associated lexicon, used to ground the keyword analysis and scoring logic.  

If you’d like, I can extract specific passages from the FHCA site to paste as quotes in each category section to further substantiate the keyword analysis.
