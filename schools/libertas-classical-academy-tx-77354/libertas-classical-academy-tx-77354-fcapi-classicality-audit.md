...
Libertas Classical Academy TX 77354 appears in the crawl data as Magnolia Classical Academy (MCA), operating as a hybrid Classical Christian school serving pre-K through 12th grade in Magnolia, TX 77354, with classes held at a local church and an emphasis on classical education within a Christian worldview. Public-facing materials emphasize a hybrid model, Christian worldview, and parental engagement as a feature of classical education, but explicit references to several core classical criteria (notably Great Books/Great Conversation, Trivium/Quadrivium, standardized “classical pedagogy” steps like Socratic seminars, and a formal living-lesson faculty model) are limited or not clearly stated in the accessible pages. The school thus demonstrates a meaningful classical orientation, but with gaps in explicit articulation of foundational elements celebrated in the canonical classical rubric.

Overall classification: SOMEWHAT CLASSICAL.

Key strengths evidenced in public materials:
- Explicit statement of classical education paired with a Christian worldview, i.e., a grounded theological orientation within a classical framework. This aligns with the Religious and Metaphysical Foundations and the Theology-based posture of classical education. Evidence: “Classical Christian Education combines the time-tested principles of Classical Education with a distinctly Christian worldview.” 
- Hybrid/scheduled structure that blends traditional schooling with home-based or family-involvement elements, reflecting a socially engaging model that can support a formation-focused approach. Evidence: “Hybrid School Model” description. 
- Parental involvement is foregrounded by the school’s public materials and Classical Education literature, aligning with the Community/Parent facet of classical education. The presence of parent-facing questions and resources (as seen in the MCA FAQ) reinforces partnership with families. 

Key gaps that prevent a full CLASSICAL designation:
- The public materials do not clearly document the Great Books/Great Conversation canon, explicit Trivium/Quadrivium framing, or a widespread use of Socratic seminars and formal living-curriculum pedagogy across grades. The classical lexicon identifies these as essential elements; evidence on MCA’s site is more general about “classical education” and Christian worldview rather than the explicit lexical anchors that define a fully classical program. See the Six Essential Elements lexicon and indicators for required keywords (e.g., Great Books, Trivium/Quadrivium, Socratic dialogue, scholé). 
- Key components such as Great Books, universal history engagement, structured memory work, and a formal teacher-mentorship living-curriculum portrait are not clearly documented in the accessible MCA pages. Negative signals in the rubric emphasize lack of Great Books/historical engagement and lack of explicit Socratic pedagogy when such elements are not stated. 
- Pedagogy statements (Socratic seminars, rest in scholé, memorization/recitation) are not explicitly demonstrated in visible MCA pages; the materials lean toward a general “classical Christian education” framing rather than the explicit articulation of classical methods. See the Pedagogy indicators in the lexicon and the lack of explicit Pedagogy exemplars on MCA pages. 
...
- Make explicit, in public materials, the Great Books/Great Conversation framework, including representative texts and a curriculum map showing how Great Books integrate with history, philosophy, theology, and literature across grades.
- Provide a formal statement of the Seven Liberal Arts (grammar, logic, rhetoric; arithmetic, geometry, music, astronomy) as the organizing architecture of the curriculum, with specific units and course mappings to grammar, logic, and rhetoric across grades.
- Publish explicit Pedagogy statements: include the use of Socratic dialogue/seminars in upper grades, scholé-inspired pacing and contemplation, memorization/recitation, and formation-through-imitation with living exemplars and classical texts.
- Clarify the Theology/Religious foundations through concrete liturgical or communal practices (e.g., chapel, hymns, sacred music, or ritual rhythms) and a more explicit articulation of the school’s theological framework beyond a Christian worldview.
- Expand the Faculty section with a “portrait of a teacher” and a formal living-curriculum model, including professional development in classical pedagogy, mentorship structures, and teacher collaboration (faculty seminars, master-apprentice models).
- Deepen Parent & Community programming: formal book studies, parent formation seminars, and structured opportunities for family participation, consistent with the “partnership with families” and “parent formation” keywords in the classical lexicon.
