...
- Mission statements, formation language, and Catholic life in school materials. 
- Explicit discussion of classical education goals, Truth/Goodness/Beauty, and parental partnership. 
- Curriculum elements including liberal arts, Great Books, Latin/Greek, and history. 
- Public-facing pedagogy: memory, recitation, narration, and integrated learning. 
- Faculty and community signals (Meet our Faculty; living curriculum; mentor culture). 
- Parental involvement and open-campus messaging (Catholic, classical school messaging). 
- Classicality Lexicon and framework for positive/negative indicators. 

Note: The school’s public materials cited above are the basis for the analysis. The Six Essential Elements of a Classical School (1) lexicon was used to guide keyword-based scoring across the six categories. The content reflects a robust classical orientation consistent with the rubric, with one category (Pedagogy) showing a more nuanced level that remains within the CLASSICAL family.

## ABSTRACT (summary)
Saint John Paul the Great Catholic High School in Denver demonstrates CLASSICAL alignment across Religious & Metaphysical Foundations, School Purpose & Goal, Curriculum, Faculty, and Parents & Community, with Pedagogy showing SOMEWHAT CLASSICAL alignment. The school emphasizes Catholic formation, Truth/Goodness/Beauty, liberal-arts curriculum, Great Books, and a memory/narration-based pedagogy, paired with strong parental partnership. The aggregate classification is CLASSICAL.
