...
- The school demonstrates substantial classical alignment in curriculum, foundational religious framing, and formation-oriented goals, with meaningful signals in parent involvement and pedagogy that are partial rather than comprehensive. Strengthening explicit Great Books/Great Conversation commitments, a precise, public-facing “living curriculum” language for faculty, and richer parent formation/community practices would push Hastings Christian School toward a full Classical rating.

- Needle-movement recommendations (high-impact, low-cost):
  - Publicly document and advertise a formal Great Books program and a public commitment to the Great Conversation in the curriculum.
  - Publish explicit statements about Socratic pedagogy (e.g., seminars, tutorials) across grade levels and how they are implemented.
  - Articulate a formal “living curriculum” concept for faculty with examples of teacher modeling, mentorship, and professional development aligned to classical pedagogy.
  - Expand parent formation initiatives (book studies, seminars, covenantal family learning) and openly invite families to participate in campus activities and visits beyond admissions.
  - Include liturgical/community practices (periodic worship/morning prayer, liturgical seasons) in the public materials to meet the Liturgical & Communal Practices criterion.

- SOURCES: Hastings Christian School firecrawl content (mission statements, Our Education/Our Philosophy pages, and statements about Trivium/Quadrivium and parental partnership).
