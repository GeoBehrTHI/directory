...
Key insights:
- Curriculum is explicitly classical (liberal arts, Great Books, Western canon) and deliberately integrated (trivium/quadrivium framing appears in the knowledge-base materials and Great Hearts messaging).
- Pedagogy emphasizes Socratic discussion, seminars, debates, and rhetoric, with a clear progression from lower to upper grades.
- Formation-focused aims (virtue, character, moral education, and contemplation) are echoed in both the public materials and the knowledge-base rubric.
- Parents and community are positioned as co-educators with visible channels for parental access (open gradebook, orientation, mentorship programs, family resources).
- Some elements of liturgical or explicit religious practice are present in the knowledge-base materials (theology, piety, sacred tradition), though the public site emphasizes a reformulated classical-Christian civic vision rather than a sect-specific liturgy.

Note: Category-by-category keyword analysis and scoring below draw on the school’s public materials (Great Hearts Cicero Prep site and related Great Hearts/campus communications) and on the Six Essential Elements keyword indicators from the knowledge-base documents.
...
Evidence
- Public materials frame an academy rooted in classical education with a theologically-inflected worldview, referencing a tradition where education seeks truth, goodness, and beauty (the Academy’s classical mission and Great Hearts framing). The site states the Great Books curriculum engages with the Western canon in a way that presupposes moral formation and virtue as aims of education. 
- The knowledge-base materials explicitly position theology and piety as guides for classical education (grounded in theology; liturgical and communal aspects are part of the classical tradition in the Six Elements lexicon). 
...
Evidence
- The Great Hearts/Cicero materials frame education as formation toward virtue and human excellence, not simply job preparation. The public messaging emphasizes becoming “great-hearted leaders” rooted in classical learning and the liberal arts, with a focus on virtue and moral education. 
- The Great Books/Western canon orientation and the aim to cultivate wisdom and virtue are repeatedly tied to the school’s mission and outcomes (e.g., preparation for higher education via a classical framework and moral formation). 
...
Why this rating
- The presence of Socratic dialogue, seminars, debates, and rhetoric training, along with a lower-school emphasis on memory and chant-like elements, aligns with CLASSICAL pedagogy. The public-facing mentor/lyceum programs reinforce a teacher-as-guide model. The alignment with the classical pedagogy signals in the Six Essentials reinforces the CLASSICAL rating. 

What would move the needle
- If the school wanted to move toward an even more explicit SCOLÉ/Scholé cadence in daily practice across all grades, the site could provide explicit documentation of regular contemplative/reciprocal learning days, quiet study periods, and a publicly visible rhythm of reflection and memory consolidation in both lower and upper grades.
...
Evidence
- The Great Hearts materials describe dedicated, enthusiastic, and intellectually excellent teachers who serve as models of learning and character; a “living curriculum” concept and a faculty-as-core-community frame are part of the classical model. The site’s emphasis on mentors, Headmaster, and a relational, teacher-centered approach aligns with a classical faculty model. 
- The alignment with the Six Essentials’ “Living Curriculum” and “Portrait of what a teacher should be” signals is present in the theoretical rubric; the Cicero Prep context reflects these ideals in public communications about teacher roles and community culture. 

Positive/Negative keyword analysis
- Positive keywords present: living curriculum, model teachers, mentors, portrait of a teacher, faculty of friends, collegial culture, moral exemplar, character formation, professional development, virtue ethics, mentorship. 
- Negative keywords present: none observed (no signals of “facilitator-only” or non-classical teacher role). The Six Essentials include negative signals for misalignment; Cicero Prep’s materials do not show those signals in the public materials.

Why this rating
- Public-facing materials consistently present a faculty model built on virtue, mentorship, and living the curriculum—core elements of CLASSICAL pedagogy and a classical faculty conception. The “dedicated teachers as models of learning and character” line and the “living curriculum” framing align with the CLASSICAL designation. 

What would move the needle
- To move toward an even stronger CLASSICAL alignment, the school could publish a formal faculty-portrait page detailing teacher qualifications, ongoing classical pedagogy training, and exemplars of teacher-leadership in classical disciplines (e.g., seminars, Great Books seminars, and public speaking activities).
...
Evidence
- The school emphasizes partnership with families, parental engagement, and parental formation via the site and related communications (Open Gradebook, family resources, orientation events, mentorship programs). The Great Hearts materials explicitly discuss parent involvement and the school’s community orientation. 
- There are explicit references to parent co-teaching roles, family involvement in classical education, and community events, which align with the Six Essentials’ “Partnership with Families” and “Formation of Affections” and “Cultural Transmission” categories. The knowledge-base lexicon includes detailed signals about parent partnerships and family formation. 

Positive/Negative keyword analysis
- Positive keywords present: parent partnership, co-teachers, family involvement, parental engagement, open campus, parent formation, community of learners, shared mission, school-parent synergy. 
- Negative keywords present: none observed; no consumer/customer-only framing of parents, and no signals of limited parent access. The public-facing materials emphasize open involvement and teacher-parent collaboration.

Why this rating
- The publicly visible communications emphasize an engaged, co-educator model with strong parental involvement and openness to campus visits, aligning with CLASSICAL expectations for parent-community partnership. The Six Essentials’ model for Parents & Community is met through explicit collaboration and community-building signals. 

What would move the needle
- To further strengthen this category, the site could add a formal, published “Parents as Partners” page detailing parent education opportunities (reading groups, book clubs, and classical education resources) and a regularly scheduled calendar of family events, strengthening the public signaling of the partnership.
