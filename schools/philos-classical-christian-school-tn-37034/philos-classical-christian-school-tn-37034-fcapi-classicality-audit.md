...
Evidence
- Public messages emphasize Christ-centered education and theological grounding (e.g., “Rooted in Christ,” “glorify God through Christ-centered education,” and “cultivating Christian virtues”). This is reinforced by passages describing biblical worldview formation and a God-centered curriculum. 
- Foundational language includes God, truth of God, and Christian virtue as guiding principles. The school materials frame education through a theological lens. 
- Location/content notes emphasize Christian partnership and worldview alignment, suggesting a liturgical/communal rhythm in practice, even if explicit liturgical terms are not always used on every page. 
...
Evidence
- Language emphasizes formation of virtue and wisdom through a biblical framework (e.g., “The student’s growth in knowledge, wisdom, and the truth of God,” “education through the lens that God created everything,” and “Laying the foundations for a lifelong love of classical learning”). 
- Claimed aims include giving students a biblical worldview and classical formation rather than mere vocational prep, with explicit reference to Christian virtue and human flourishing. 
- Explicit partnership with parents and a biblically framed curriculum support the telos of classical formation rather than a purely market-driven or job-prep goal. 
...
Evidence
- The site signals a classical approach and involves logic and reasoning in academics, with claims about “education that integrates content and training students in logic and reasoning.” This matches some classical features. 
- References to a “biblical, classical and comprehensive curriculum” suggest a classical structure, though explicit mentions of core classical curriculum components (grammar, logic, rhetoric; Great Books; history across the curriculum; Great Conversation) are not clearly enumerated in the public materials shown. 
- Some content implies a history-leaning or classical framework, but explicit components such as Great Books reading, Great Conversation, and a full Trivium progression are not explicitly demonstrated in the excerpts available. 
...
Evidence
- The materials indicate emphasis on reasoning and logic development within an integrated curriculum, and a sense that learning should be meaningful and formative. However, there is no explicit public articulation of key classical pedagogy elements (Socratic seminars in upper grades, formal chanting/memory work, or a clear implementation of scholé in the lower grades) in the excerpts provided. 
- There is mention of a biblically integrated approach and a classical approach; the absence of explicit lower-grade singing/chanting, memory work, or explicit Latin/Greek pedagogy in the public-facing text limits a full CLASSICAL pedagogy claim. 

Positive/Negative Keyword Analysis
- Positive keywords present: contemplative/restful learning (not explicitly stated but implied by “well-structured, thoughtful education” language in classical tradition), logic, reasoning, and a classical approach.
- Negative keywords: absence of explicit Socratic seminars, memory-based chant, or rigorous rhetoric training in upper grades; no explicit Scholé-language usage on the site. 

Why this rating
- The school's public materials suggest a classical orientation but stop short of detailing the full pedagogy (e.g., Socratic discussion, rhetoric training, or rigorous memory/recitation practices). This yields a SOMEWHAT CLASSICAL rating for pedagogy until more explicit public evidence is provided. 
...
Positive/Negative Keyword Analysis
- Positive keywords present: teachers as mentors, living curriculum, founder-led instruction, model teachers (implied). Explicit terms like "mentors" or "living curriculum" are not strongly stated in the content, but the relational language (parent-teacher partnership) and named faculty signal a teacher-centric model.
- Negative keywords: None evident (no language suggesting “facilitators on the side” or purely administrative instructors without classical context).

Why this rating
- The presence of named faculty, founder leadership, and a school culture that centers teachers as primary agents supports a SOMEWHAT CLASSICAL rating for Faculty, given that explicit phrases such as "living curriculum" or "portrait of a teacher" are not overtly stated in the public content. 
...
- Make Great Books/Great Conversation explicit: Public materials should clearly articulate a Great Books program and the Great Conversation framework, including representative readings, and a stated expectation of student engagement with primary sources and canonical works across grades.
- Publicly document full Trivium components: Explicitly name and describe the grammar, logic, and rhetoric progression, with a plan for memory work, recitation, and classical modes (e.g., prosaic and poetic memory, standard forms of argument).
- Expand and articulate pedagogy: Present concrete examples of Socratic seminars, debates, and rhetoric instruction across upper grades; articulate how scholé/restful learning is implemented (e.g., schedule, spaces, and practices) to align with scholé language.
- Deepen curricular visibility: Provide a clear map of curriculum elements (history as a Western/Christian history, primary sources, integration with theology) and indicate specific Great Books or canonical authors read within the program.
- Enhance liturgical/communal elements: If appropriate within the school’s mission, clearly describe liturgical or worship-related practices, calendar integration, and how communal worship or prayer informs daily learning.
