...
- Core items and language come from Detroit Christian School public materials (e.g., Academics, Portrait of a Graduate, Admissions, Our Story, and Faith-related pages) which explicitly frame a Christ-centered, classical education and the Tri-vars framework, along with family partnerships and formation signals. Representative citations include the Christ-centered/classical framing and Trivium emphasis (turn0file0); the Portrait of a Graduate with biblical/theological scope (turn0file1); and theological statements and admissions content (turn0file10, turn0file15).
