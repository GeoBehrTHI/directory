...
- Not necessary here. All six categories reach CLASSICAL in the rubric. If one sought incremental refinement, the school could further codify explicit statements tying daily classroom practices to explicit transcendentals (though evidence already exists in multiple pages) and highlight more explicit documentation of student assessment linked to virtue beyond traditional metrics.

Note: All quantitative keyword analyses below rely on the Positive/Negative keyword indicators from the Six Essential Elements of a Classical School (1) and are grounded in Petra Academy public materials.
...
Evidence
- The mission proclaims partnership with parents to cultivate “faithful Christian students who delight in truth, beauty, and goodness in their worship, work, and service.” 
- Petra identifies as a “classical Christian school,” with Jesus Christ as “source and goal of all creation and history, and the center of any discussion of truth, beauty, and goodness.” 
- The school explicitly anchors in Scripture and Christian creeds (Apostles’ Creed, Nicene Creed, Westminster Confession, Heidelberg Catechism) per its Statement of Faith and accreditation material. 
- Distinctives articulate a “paideia of Christ” and a liturgical/community sense of formation around truth, goodness, and beauty. 
...
Why this rating
- Petra explicitly grounds education in Christian theology and metaphysical commitments, treats truth/goodness/beauty as real and knowable, and embeds liturgical-like, communal practices through mission, creed, Scripture, and paideia language. The Positive keyword set is densely populated while the Negative keyword set is not evident in Petra’s public materials. This alignment satisfies Transcendental Moral Realism, Grounded Theology, and Liturgical/Communal practices as described in the Classical rubric.
...
Evidence
- The mission centers formation through virtue and delight in truth, beauty, and goodness within worship, work, and service. 
- The school emphasizes education as formation (not merely information) and the cultivation of humanity/excellence, with explicit mention that truth, goodness, and beauty are real and knowable. 
- The public narrative ties formation to a holistic end—cultivating character and a contemplative life in alignment with Christian moral aims (evident in “education is about formation” and the Great Conversation framework). 
...
Why this rating
- Petra’s mission and content repeatedly frame education as the cultivation of virtue and wisdom (formation) rather than mere information or job preparation. The public materials stress human excellence through truth/beauty/ goodness in a theologically grounded context, aligning strongly with CLASSICAL criteria for purpose and goal.
...
Evidence
- Distinctives describe the Trivium (grammar, logic, rhetoric) and Quadrivium as central structure; pre-grammar through upper grades are mapped to grammar (1–6), dialectic (7–9), rhetoric (10–12). 
- Academics section states: “Using the three-way methodology of the classical trivium (grammar, logic, and rhetoric), we desire that our students be well grounded in the fundamentals of the core curriculum, that they reason well, and that they articulate with precision and grace. Along with the trivium, we also engage in the quadrivium, expanding the students course of study to include the arts, math, and science.” 
- Curriculum Overview highlights Latin (grades 3–9), formal logic (grades 8–9), rhetoric (grades 11–12), Bible integration, and emphasis on Great Books with primary sources; Bible classes integrated as core. 
- The “Resource/Curriculum” content notes emphasis on Great Books of Western civilization and primary source material to cultivate sensibilities with the best that has been written. 
- The Petra Distinctives emphasize “grammar, logic, and rhetoric” as the core of learning and “Quadrivium” for a thorough education. 
...
Why this rating
- Petra’s curriculum is clearly anchored in classical core content and methods: Trivium/Quadrivium, Great Books, Latin/logic/rhetoric, Bible integration, and a “great conversation” through primary sources. The presence of pre-grammar through rhetoric stages and explicit emphasis on memorization and wonder (e.g., chants for grammar) aligns strongly with the CLASSICAL criteria for curriculum.
...
Evidence
- TheDistinctives describe “restful learning” in the early years and “Observing with Humility” in grammar stage, using chants and songs to reinforce fundamentals, and “Thinking with Reason” in dialectic/logic stage through debate, animated discussion, and persuasive writing. 
- The dialectic/logic stage explicitly references reasoned debate and argumentative discussion; the rhetoric stage emphasizes articulation and persuasive presentations. 
- The Petra methodology page describes age-specific learning aligned with stage development and the “great conversation” across ages; the aim is to train students to observe humbly, think logically, and articulate charitably. 
- The Curriculum/Academics page emphasizes “formation” and “eyes to see the world the way God sees it,” implying contemplative/restful aspects alongside rigorous instruction. 
...
Why this rating
- Petra’s pedagogy combines restive, chant-based memory work in the grammar stage with Socratic/debate-based inquiry in the dialectic stage and rhetorical training in the rhetoric stage, complemented by contemplative aims and a holistic paideia. This aligns with CLASSICAL pedagogy expectations, including both memory work and rigorous reasoning/dialogue in appropriate age bands.
...
Why this rating
- Petra explicitly presents its faculty as virtuous, mission-aligned mentors who are central to the living curriculum, with a focus on character, virtue, and partnership with families. This matches the classical expectation of faculty as the core of the school's living tradition and as role models, earning CLASSICAL in this category.
...
Why this rating
- Petra frames parents as essential partners and co-educators in the classical project, with explicit mechanisms for engagement (portal, events, blogs, feedback). The community-facing language and family-centered practices align with CLASSICAL expectations for parent/community involvement.

---

## What Would Move the Needle

- Since all six categories reach CLASSICAL, no major needle-moving changes are necessary. If a future refinement were desired, Petra could further codify and publish explicit mappings from daily classroom activities to the transcendentals (truth/goodness/beauty) and provide concise, public rubrics showing how each grade level’s assignments and assessments reflect formation, great books engagement, and Socratic/seminar practices to make alignment even more transparent.
