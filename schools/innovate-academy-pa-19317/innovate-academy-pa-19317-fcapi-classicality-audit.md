...
Evidence
- The school identifies itself as a “classical Christian school,” signaling a trans-hypostatic foundation that integrates faith with learning (PreK–9th grade classical Christian school). 
- Public materials describe God-centered language and worship-oriented activities (e.g., “begin our journey to share God's love … through our words, actions, and worship”). 
...
Positive/Negative keyword analysis
- Positive indicators present: the label “classical Christian school” itself is a positive signal for a classical framing, but this category requires explicit curricular elements (grammar, logic, rhetoric; Great Books; history as history; etc.), which are not clearly listed in the sources. 
- Negative indicators present: lack of explicit classical curriculum keywords (Great Books, Trivium, Quadrivium, Latin/foreign languages, history-as-history, etc.). The visible materials emphasize biblical content and church-related curriculum rather than a canonical classical curriculum. 

Why this rating
- Because explicit classical curriculum components (grammar–logic–rhetoric, Great Books/Great Conversation, liberal arts sequencing) are not clearly documented in the public materials, this category does not reach the CLASSICAL standard, and is better characterized as NOT CLASSICAL in curriculum terms based on the available evidence. 
...
Positive/Negative keyword analysis
- Positive indicators for classical pedagogy would include terms like Socratic seminar, scholé, memory work, recitation, dialectic, etc. None of these appear in the visible public materials in a sustained manner. 
- Negative indicators: the dominant religious, worship, and discipleship language with limited classical pedagogical vocabulary. This pushes the category toward NOT CLASSICAL pedagogically. 

Why this rating
- Without explicit Classical pedagogy (Socratic dialogue, memory work, recitation, or a sustained scholé approach), the category does not align with the classical pedagogy rubric. The visible content leans more toward faith-driven formation and ministry-oriented activities rather than a rigorous classical teaching method. 
...
Positive/Negative keyword analysis
- Positive indicators: partnership with parents, co-educating families through faith-based programs, family discipleship, open access to ministry-related content (Beliefs, Our Story, etc.). These map to the “Parents and Community” positive signals in the Six Elements lexicon (parent formation, seminars, open campus, parent covenant, etc.). 
...
- Add explicit Great Books/Great Conversation framing to the Curriculum section (e.g., list liberal arts components, canonical texts, and a clear Trivium progression).
- Make the classical pedagogy explicit (Socratic seminars, scholé, memory work, recitation, and rhetoric training) and demonstrate how these practices are implemented from K–12.
- Develop a clearly stated “living curriculum” concept for Faculty, including teacher professional development in classical pedagogy and a documented teacher portrait aligned with classical aims.
- Publish explicit language around the core classical telos (truth, goodness, beauty) and how these ideals are pursued across subjects, with examples in history, literature, and language arts.
- Strengthen explicit parent education and partnership programs (e.g., parent seminars, book studies, and a formal “parents as co-teachers” framework) to more clearly map onto classical school norms.
- Align the history curriculum with traditional classical emphasis (history as an ongoing through-line in all disciplines rather than a stand-alone “social studies” frame) and incorporate Great Books or primary-source readings where possible.
- Elevate science and humanities integration to demonstrate how the liberal arts approach informs STEM and humanities, with clear mapping to the Trivium/Quadrivium framework and the Great Conversation ethos.
