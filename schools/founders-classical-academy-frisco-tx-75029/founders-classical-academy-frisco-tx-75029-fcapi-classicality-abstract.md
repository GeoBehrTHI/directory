...
Notes:
- Evidence drawn from public-facing materials on Founders Classical Academy - Frisco’s site, including statements about classical education, virtue, and a liberal-arts curriculum. See sources describing the program’s orientation toward truth, beauty, and goodness and formation/virtue aims. 
- Positive/negative keyword guidance is grounded in the Six Essential Elements lexicon, which identifies positive indicators (e.g., truth, goodness, beauty; virtue; formation; liberal education) and negative signals (e.g., secular relativism) relevant to each category. 
- Evidence for Parents & Community is supported by explicit statements about partnering with families and public event/activity listings (e.g., PTO events).
