...
Cited sources illustrating key patterns and phrases:
- Four Classical Virtues and formation language: “Our Four Classical Virtues” and “formation of mind and character.”  
- Great Books, primary sources, and classical curriculum orientation: “True History using primary source documents,” “reading the Great Books,” etc. 
- Pedagogical methods (Socratic/dialogue, seminars, rhetoric): explicit language about Socratic discussions and rhetoric training. 
- Faculty as core (living curriculum) and Pillars: teacher-centered, virtue-focused framing.  
- Parental/community engagement and open houses: tours, admissions inquiries, and events. 

If you’d like, I can extract verbatim quotes from specific pages to illustrate each keyword match more granularly or tailor the scoring percentages more tightly to sub-phrases you care about.
