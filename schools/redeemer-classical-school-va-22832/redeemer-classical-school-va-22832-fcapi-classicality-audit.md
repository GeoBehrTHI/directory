...
- Evidence: Narratives emphasize formation, virtue, wisdom, and the pursuit of truth, goodness, and beauty as real goods guiding education (as reflected in Christian/theological framing and classical aims). 
- Positive/Negative keyword analysis: Keywords such as formation, virtue, wisdom, teleology, and the pursuit of truth/goodness/beauty appear in context; secular, job-prep language is not prominent in public materials.
- Why this rating: The thrust is formation and character development rather than vocational Olympics or job-preparation rhetoric, consistent with Classical aims.
...
- Evidence: Use of contemplative/scholé elements (restful learning, memorization, chant) in the grammar stage, with Socratic discussion and rhetoric-focused work in the upper grades. The site highlights questioning over simple transmission and emphasizes student thinking. 
- Positive/Negative keyword analysis: Positive pedagogical signals include Socratic dialogue, scholé, memorization/recitation (chanting), and rhetoric; a complete exclusion of project-based-only approaches in the public materials is not indicated.
- Why this rating: The pedagogy aligns with classical methods (Scholé/restful learning, memory work, and later Socratic/seminar-style discourse).

Element 5: Faculty — CLASSICAL

- Evidence: Faculty profiles present teacher as moral exemplars and mentors; descriptions emphasize living curriculum and collegial, relationship-driven teaching; explicit intent to model virtue and cultivate character. 
- Positive/Negative keyword analysis: Positive keywords include virtuous teaching, living curriculum, mentorship, portrait of teacher/student ideals; no overt negative signals observed in public materials.
- Why this rating: The faculty is framed as guides and living exemplars supporting the classical mission, consistent with classical education norms.
...
- Based on category-by-category evidence, Redeemer Classical School VA 22832 demonstrates consistent CLASSICAL orientation across five categories and a solid, though less explicit, alignment in Parents & Community. Aggregately, the school is CLASSICAL.

What would move the needle

- For a move toward a fuller CLASSICAL status in Element 6 (Parents & Community), the school could foreground explicit parent-partnership language on its public site, including statements like “Partnership with Families: we view parents as co-educators and invite them to participate in the ethos of classical education,” along with observable programs (parent book studies, family catechesis, open-campus visitation, parent seminars). This would align Element 6 more strongly with the Positive Keywords in the Six Essential Elements lexicon. It would also reinforce the public narrative of parental partnership as a core element of classical education.
