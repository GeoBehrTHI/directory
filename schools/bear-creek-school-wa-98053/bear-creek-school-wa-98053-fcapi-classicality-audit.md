...
Notes on how the six-category rubric was applied:
- Element 1, 2, 5, and 6 show strong alignment with classical, Christian formation and community practices, including explicit theological framing, virtue cultivation, and tight-knit faculty/community emphasis.
- Element 3 (Curriculum) and Element 4 (Pedagogy) show clear classical markers (e.g., trivium, liberal arts, teacher-student formation), but some hallmark elements (extensive Great Books/Great Conversation programming, explicit Socratic seminar culture in upper grades, and explicit historical curriculum framing throughout the program) are less directly evidenced in the crawl. This yields a SOMEWHAT CLASSICAL designation for these two categories, and a move toward CLASSICAL would require additional explicit textual signals in those areas.

What would move the needle
- Element 3 (Curriculum): Add explicit Great Books/Great Conversation components and a clearly stated history-integration across disciplines (not framed as social studies). Include language about cultivation and experience of wonder as part of daily learning. 
- Element 4 (Pedagogy): Document and publicize explicit Socratic discussion, seminars, or debates in upper grades, with a visible rhetoric-skills program (speeches, debates) to match the classical pedagogy model.
- Element 1 (Religious and Metaphysical Foundations) and Element 2 (Purpose and Goal): Consider weaving explicit liturgical or communal prayer/worship rhythms into daily/weekly schedules and demonstrating how these practices shape character formation in direct alignment with transcendentals (truth, goodness, beauty) and the Logos-based framework.
